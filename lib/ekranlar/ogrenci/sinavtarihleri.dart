...
class sinavtarihleriPage extends StatefulWidget {
  @override
  _sinavtarihleriPageState createState() => _sinavtarihleriPageState();
}

class _sinavtarihleriPageState extends State<sinavtarihleriPage> {
        ...
        children: [
          ...
          Flexible(
            child: StreamBuilder<QuerySnapshot>(
              stream:getirSinavlarDT().where('s_ogr_no',isEqualTo: listKullanici.kl_uni_no).orderBy('s_ders_no').snapshots(),
                                ...
                                decoration: BoxDecoration(
                                    border: Border.all(
                                        ...
                                        color: Colors.grey
                                            .withOpacity(0.5))),
                                child: Text(
                                    "${Sinavlar.fromFirestore(listOfDocumentSnap[index].data()).s_ders_no}"),
                              ),
                            ),
                            Expanded(
                              flex:6,
                                ...
                                decoration: BoxDecoration(
                                    border: Border.all(
                                        ...
                                        color: Colors.grey
                                            .withOpacity(0.5))),
                                child: Text(
                                    "${Sinavlar.fromFirestore(listOfDocumentSnap[index].data()).s_ders_adi}"),
                              ),
                            ),
                            Expanded(
                              flex:3,
                                ...
                                decoration: BoxDecoration(
                                    border: Border.all(
                                        ...
                                        color: Colors.grey
                                            .withOpacity(0.5))),
                                child: Text(
                                    "${Sinavlar.fromFirestore(listOfDocumentSnap[index].data()).s_vize_t}"),
                              ),
                            ),
                            Expanded(
                              flex:3,
                                ...
                                decoration: BoxDecoration(
                                    border: Border.all(
                                        ...
                                        color: Colors.grey
                                            .withOpacity(0.5))),
                                child: Text(
                                    "${Sinavlar.fromFirestore(listOfDocumentSnap[index].data()).s_final_t}"),
                              ),
                            ),
                            Expanded(
                              flex:3,
                                ...
                                decoration: BoxDecoration(
                                    border: Border.all(
                                        ...
                                        color: Colors.grey
                                            .withOpacity(0.5))),
                                child: Text(
                                    "${Sinavlar.fromFirestore(listOfDocumentSnap[index].data()).s_butunleme_t}"),
                              ),
                            ),
                          ],
                        ),
